  ...
  return (
    <div className="flex h-screen">
        ...
        <div className="max-w-md">
          ...
          <div className="relative">
            ...
            <div className="relative flex items-center justify-center h-96 bg-white rounded-lg shadow-lg p-4">
              <img src="/website-design.jpg" width="1000" height="1000" alt="" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex justify-end mb-4">
          ...
          <a href="#" className="text-blue-500 ml-2"> Sign in</a>
        </div>
        ...
        <label className=" text-sm text-gray-500">
          This site is protected by reCAPTCHA and the Google <a href="#" className="text-blue-500 underline" target="_blank" rel="noopener noreferrer">Privacy Policy</a> and
          <a href="#" className="text-blue-500 underline" target="_blank" rel="noopener noreferrer"> Terms of Service</a> apply.
        </label>
      </div>
    </div>
  );
